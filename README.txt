...
username,password,enemy's main subreddit name,General 1, General 2, General 3, etc 
**Note that there is no limit to the number of generals**

Example:
Peri_Prime,prime_password,orangered,Sahdee,RockdaleRooster,NaughtyPenguin